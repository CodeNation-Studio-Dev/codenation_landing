...
export const Categories = () => {
  ...
  return (
    <section
      ref={ref}
      className="font-inter mt-20 flex w-full overflow-hidden px-2 pb-20 sm:px-7 lg:h-[930px] lg:px-3 xl:px-4"
    >
      <div className="categories-container h-[95svh]">
        <div
          ref={panelRef}
        ...
        >
          <header className="flex flex-col gap-y-6 px-[25px] py-[30px] lg:w-[850px] lg:min-w-[850px] lg:justify-between lg:pr-[180px] lg:pl-[50px]">
            <div>
              ...
              <h2 className="indent-[50px] text-4xl">
                From front-end development to crafting beautiful, funcional
                digital spaces
              </h2>
            </div>
            <span className="text-md flex indent-[50px] font-light lg:w-[400px] lg:self-end">
              I specialize in building interactive, accessible, and
              purpose-driven websites. I'm passionate about crafting web
              experiences that are both functional and emotionally resonant
            </span>
            ...
            />
            <p>These projects are developed</p>
          </header>
