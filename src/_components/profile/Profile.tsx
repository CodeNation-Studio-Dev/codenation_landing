...
export const Profile = ({ user }: { user: string }) => {
  ...
  return (
    <section>
      <main
        className="flex h-auto justify-center lg:pb-20"
        style={{ minHeight: "calc(var(--vh, 1vh) * 100)" }}
      >
        <div className="h-full w-full overflow-visible">
          <div
            className="relative flex h-full w-full -translate-y-20 bg-gray-50"
            style={{ minHeight: "calc(var(--vh, 1vh) * 100)" }}
          >
            <img
          ...
          <div className="font-inter relative z-10 -mt-[38vh] flex w-full max-w-380 flex-col gap-5 justify-self-center p-1 sm:-mt-[25vh] sm:pl-5 lg:-mt-[60vh] lg:flex-row lg:items-center lg:justify-between 2xl:-mt-[60vh]">
            <div>
              <div className="flex flex-col sm:gap-5 md:flex-row lg:flex-col lg:gap-0">
            ...
            <div className="flex min-h-90 w-full max-w-150 flex-col lg:max-w-100">
